...
(
  ...
  CONSTRAINT FK_facultad_carrera_facultad FOREIGN KEY (facultad_id, universidad_id) REFERENCES facultad(facultad_id ),
...
(
  ...
  FOREIGN KEY FK_cargo_banca_banca (banca_id) REFERENCES banca(banca_id),
  FOREIGN KEY FK_cargo_banca_orden (orden_id) REFERENCES orden(orden_id)
);
...
(
  ...
  CONSTRAINT FK_cargo_banca_estudiante_cargo_banca FOREIGN KEY (cargo_id, banca_id, orden_id) REFERENCES cargo_banca(, , ),
...
(
  ...
  orden_id INT NOT NULL,
  documento_estudiante INT NOT NULL,
  CONSTRAINT PK lista_cargos PRIMARY KEY (lista_id, cargo_id, banca_id, orden_id, documento_estudiante),
  CONSTRAINT FK_lista_cargos_lista FOREIGN KEY (lista_id) REFERENCES lista(lista_id),
  CONSTRAINT FK_lista_cargos_cargo_banca_estudiante FOREIGN KEY (cargo_id, banca_id, orden_id, documento_estudiante) REFERENCES cargo_banca_estudiante(, , , )
);
...
(
  ...
  codigo_token varbinary NOT NULL,
  usado CHAR(2) NOT NULL,
  mesa_identificacion_is INT NOT NULL,
  CONSTRAINT PK_token_votante PRIMARY KEY (token_id),
  CONSTRAINT FK_token_votante_mesa_identificacion FOREIGN KEY (mesa_identificacion_is) REFERENCES mesa_identificacion(mesa_identificacion_id),
...
(
  ...
  token_id INT NOT NULL,
  mesa_votacion_id INT NOT NULL,
 CONSTRAINT PK_voto  PRIMARY KEY (lista_id),
